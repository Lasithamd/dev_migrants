        ...
        <div class="d-flex align-items-center">
            ...
            <a class="text-decoration-none navbar-brand text-left" href="/">
                <div class="d-flex align-items-center py-3">
                    ...
                    <span class="font-sans-serif text-primary">MS Portal</span>
                </div>
            </a>
        </div>
                ...
                <ul class="flex-column navbar-nav">
                    ...
                    <li class="nav-item">
                        <div class="mt-3 mb-2 navbar-vertical-label-wrapper row">
                            <div class="navbar-vertical-label navbar-vertical-label col-auto">Ads</div>
                            <div class="ps-0 col">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('admin/ads')}}">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">Advertiestment</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        >
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">Profiles</span>
                            </div>
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.district') }}">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">District</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.city') }}">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">City</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <div class="mt-3 mb-2 navbar-vertical-label-wrapper row">
                            <div class="navbar-vertical-label navbar-vertical-label col-auto">Advertiestment</div>
                            <div class="ps-0 col">
                                <hr class="mb-0 navbar-vertical-divider">
                            </div>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('admin/category') }}">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">Industry</span>
                            </div>
                        </a>
                        <ul class="flex-column nav collapse navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('admin.category') }}">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">Main Category</span>
                                    </div>
                                </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('admin.subcategory') }}">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">Sub Category</span>
                                    </div>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">Educations</span>
                            </div>
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">Univercity</span>
                            </div>
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/widgets">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">Analytices</span>
                            </div>
                        </a>
                    </li>
                    <li class="nav-item">
