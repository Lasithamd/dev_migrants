    ...
    <nav class="navbar-vertical navbar navbar-expand-xl navbar-light">
        ...
        <div class="navbar-collapse collapse" style="background-image: none;">
            <div class="navbar-vertical-content scrollbar">
                <ul class="flex-column navbar-nav">
                    <li class="nav-item">
                        <a
                            aria-expanded="false"
                            role="button"
                            class="dropdown-indicator cursor-pointer nav-link"
                            tabindex="0"
                            href="#"
                        >
                            <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        <div class="mt-3 mb-2 navbar-vertical-label-wrapper row">
                            <div class="navbar-vertical-label navbar-vertical-label col-auto">Jobs</div>
                            <div class="ps-0 col">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/app/calendar">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">Applications</span>
                            </div>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/email/inbox">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/email/email-detail">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/email/compose">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/events/create-an-event">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/events/event-detail">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/events/event-list">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                ...
                                <ul class="flex-column nav collapse navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/e-commerce/product/add-product">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text ps-1">Add a product</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/e-commerce/product/product-list">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/e-commerce/product/product-grid">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/e-commerce/product/product-details">
                                            <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="flex-column nav collapse navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/e-commerce/orders/order-list">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/e-commerce/orders/order-details">
                                            <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/e-commerce/customers">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/e-commerce/customer-details">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/e-commerce/shopping-cart">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/e-commerce/checkout">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/e-commerce/billing">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/e-commerce/invoice">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        >
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">E Learning</span>
                                <div class="ms-2 badge badge-subtle-success rounded-pill">New</div>
                            </div>
                        </a>
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                ...
                                <ul class="flex-column nav collapse navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/e-learning/course/create-a-course">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text ps-1">Create a course</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/e-learning/course/course-list">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/e-learning/course/course-grid">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/e-learning/course/course-details">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text ps-1">Course details</span>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/e-learning/student-overview">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">Student overview</span>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/e-learning/trainer-profile">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">Trainer profile</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/app/kanban">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
                                    <svg
                                        aria-hidden="true"
                                        ...
                                        data-prefix="fab"
                                        data-icon="trello"
                                        class="svg-inline--fa fa-trello fa-w-14 "
                                        role="img"
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 448 512"
                                    >
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/social/feed">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/social/activity-log">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/social/notifications">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/social/followers">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/support-desk/table-view">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">Table view</span>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/support-desk/card-view">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">Card view</span>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/support-desk/contacts">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/support-desk/contact-details">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/support-desk/tickets-preview">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">Tickets preview</span>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/support-desk/quick-links">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/support-desk/reports">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        <div class="mt-3 mb-2 navbar-vertical-label-wrapper row">
                            <div class="navbar-vertical-label navbar-vertical-label col-auto">Locations</div>
                            <div class="ps-0 col">
                                <hr class="mb-0 navbar-vertical-divider">
                            </div>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/pages/starter">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
                                    <svg
                                        aria-hidden="true"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/landing">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="nav-link-text ps-1">Province</span>
                            </div>
                        </a>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/pricing/pricing-default">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/pricing/pricing-alt">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/faq/faq-basic">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/faq/faq-alt">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/faq/faq-accordion">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/errors/404">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/errors/500">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/miscellaneous/associations">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/miscellaneous/invite-people">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/miscellaneous/privacy-policy">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        <div class="mt-3 mb-2 navbar-vertical-label-wrapper row">
                            <div class="navbar-vertical-label navbar-vertical-label col-auto">Modules</div>
                            <div class="ps-0 col">
                                <hr class="mb-0 navbar-vertical-divider">
                            </div>
                        </div>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                ...
                                <ul class="flex-column nav collapse navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/basic/form-control">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/basic/input-group">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/basic/select">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/basic/checks">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/basic/range">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/basic/layout">
                                            <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="flex-column nav collapse navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/advance/advance-select">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/advance/date-picker">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/advance/editor">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/advance/emoji-button">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/advance/file-uploader">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/advance/input-mask">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text ps-1">Input mask</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/advance/range-slider">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text ps-1">Range slider</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/forms/advance/rating">
                                            <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/forms/wizard">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/tables/basic-tables">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/tables/advance-tables">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/charts/d3js">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">D3js</span>
                                        <div class="ms-2 badge badge-subtle-success rounded-pill">New</div>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                ...
                                <ul class="flex-column nav collapse navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/charts/echarts/how-to-use">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/charts/echarts/line-charts">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/charts/echarts/bar-charts">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/charts/echarts/candlestick-charts">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/charts/echarts/geo-map">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/charts/echarts/scatter-charts">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/charts/echarts/pie-charts">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/charts/echarts/radar-charts">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/charts/echarts/heatmap-charts">
                                            <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                            ...
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
                                    <svg
                                        ...
                                        data-prefix="fas"
                                        data-icon="shapes"
                                        class="svg-inline--fa fa-shapes fa-w-16 "
                                        role="img"
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 512 512"
                                    >
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/icons/react-icons">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">React icons</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/maps/google-map">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/maps/leaflet-map">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/components/alerts">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/accordion">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/animated-icons">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/background">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">Backgrounds</span>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/components/badges">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/breadcrumb">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/buttons">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/calendar">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/cards">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="flex-column nav collapse navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/carousel/bootstrap">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/carousel/slick">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text ps-1">Slick</span>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/collapse">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/cookie-notice">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/countup">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/draggable">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/dropdowns">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/list-group">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/modals">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/offcanvas">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="flex-column nav collapse navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/navs-and-tabs/navs">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/navs-and-tabs/navbar">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/navs-and-tabs/vertical-navbar">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/navs-and-tabs/top-navbar">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/navs-and-tabs/double-top-navbar">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text ps-1">Double Top</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/navs-and-tabs/combo-navbar">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/navs-and-tabs/tabs">
                                            <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="flex-column nav collapse navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/pictures/avatar">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/pictures/images">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/pictures/figures">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/pictures/hoverbox">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/pictures/lightbox">
                                            <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/progress-bar">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/pagination">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/placeholder">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/popovers">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/scrollspy">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/search">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/spinners">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/timeline">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/toasts">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/tooltips">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/treeview">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/components/typed-text">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="flex-column nav collapse navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/videos/embed">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/components/videos/react-player">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text ps-1">React Player</span>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/background">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/borders">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/colors">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/colored-links">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/display">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/flex">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/float">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/grid">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/scroll-bar">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-text ps-1">Scroll Bar</span>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/position">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/spacing">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/sizing">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/stretched-link">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/text-truncation">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/typography">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/vertical-align">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/utilities/visibility">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        <div class="mt-3 mb-2 navbar-vertical-label-wrapper row">
                            <div class="navbar-vertical-label navbar-vertical-label col-auto">Documentation</div>
                            <div class="ps-0 col">
                                <hr class="mb-0 navbar-vertical-divider">
                            </div>
                        </div>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="flex-column nav collapse navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="/documentation/configuration">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/documentation/styling">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/documentation/dark-mode">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/documentation/plugin">
                                    <div class="d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/documentation/faq">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
                                    <svg
                                        aria-hidden="true"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/documentation/design-file">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
                                    <svg
                                        aria-hidden="true"
                ...
                <li class="nav-item">
                    <div class="mt-3 mb-2 navbar-vertical-label-wrapper row">
                        <div class="navbar-vertical-label navbar-vertical-label col-auto">Customization</div>
                        <div class="ps-0 col">
                            <hr class="mb-0 navbar-vertical-divider">
                        </div>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/documentation/getting-started">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="nav-link-text ps-1">Layouts</span>
                        </div>
                    </a>
                </li>
                <li class="nav-item">
